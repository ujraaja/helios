...
Scenario: I expect to be able to return to the filters page from the results page using "Go to previous page"
  Given I am on the results page
  And I expect to see a "submit" input labeled "Go to previous page"
